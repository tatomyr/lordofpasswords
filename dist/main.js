...
var _Inputs = __webpack_require__(/*! ./components/Inputs */ "./src/components/Inputs.js");
...
var _Spinner = __webpack_require__(/*! ./components/Spinner */ "./src/components/Spinner.js");
...
var App = function (_React$Component) {
  ...
  _createClass(App, null, [{
    key: 'pwChar',
    value: function pwChar(code) {
      var pwCharSet = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'; // 62 symbols
      return pwCharSet[code % pwCharSet.length];
    }
  }, {
    key: 'pw3',
    value: function pw3(service_, salt_, pwLength) {
      ...
      var jOffset = sum % service.length;
      var kOffset = sum % (salt.length + 1);

      // I don't know why, but Array(pwLength).fill(0) doesn't create an array properly
      var pwArr = [];

      for (var i = 0; !(i >= pwLength && i >= service.length && i >= salt.length + 1); i++) {
        var innerSalt = salt + App.pwChar(i);

        // Service & salt offsets:
        var _j = (i + jOffset) % service.length;
        var _k = (i + kOffset) % innerSalt.length;

        pwArr[i % pwLength] = (pwArr[i % pwLength] || 0) + i + service.charCodeAt(_j) ** 2 + innerSalt.charCodeAt(_k) ** 2;
      }

      var password = pwArr.reduce(function (prev, item) {
        return prev + App.pwChar(item);
      }, '');
      return password;
    }
  }]);
  ...
  _createClass(App, [{
    ...
    key: 'getRecurrPw',
    value: function getRecurrPw(service, salt, pwLength, callback) {
      var password = App.pw3(service, salt, pwLength);

      var upperCasedCount = 0;
      var lowerCasedCount = 0;
      var numbersCount = 0;
      /* // Mobile IE doesn't support this
    ...
    value: function handleSubmit(e) {
      ...
      var service = e.target.service.value.toString();
      var salt = e.target.salt.value.toString();
      var pwLength = e.target.pwLength.value;
      localStorage.pwLength = pwLength;

      if (service && salt && pwLength) {
        this.setState({ displaySpinner: 'block' });
        setTimeout(function () {
          _this2.getRecurrPw(service, salt, pwLength, function (password) {
            _this2.setState({ password: password });
            _this2.password.select();
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'h6',
              null,
              'keep in mind one \'salt\''
            )
          ),
          !this.state.password ? _react2.default.createElement(_Inputs2.default, {
            handleSubmit: function handleSubmit() {
              return _this3.handleSubmit();
            },
            pwLength: localStorage.pwLength || 10
          }) : _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(
        ...
        _react2.default.createElement(_Spinner2.default, { display: this.state.displaySpinner })
      );
    }
  }]);
...
exports.default = function () {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        "a",
        { className: "banner__link", href: "old/index.html" },
        "here"
      )
    )
  );
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        { htmlFor: 'salt' },
        '\'Salt\'',
        _react2.default.createElement('input', { type: 'password', name: 'salt', id: 'salt', placeholder: '...' })
      )
    ),
    _react2.default.createElement(
      'div',
      { className: 'input-container' },
      _react2.default.createElement('input', { type: 'submit', value: 'Get password' })
    )
  );
};
...
Inputs.propTypes = {
  ...
  pwLength: _propTypes2.default.number.isRequired
};
...
var Spinner = function Spinner(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    { className: 'spinner', style: { display: display } },
    _react2.default.createElement('img', { className: 'spinner__img', src: '/spinner.gif', alt: 'loading...' })
  );
};
